...
import CodeMirrorStyle from '../../lib/codemirror.css' with {type:'css'};
...
//import { insertCSSStyleSheet, insertCSSStyleLink } from '../util/insert-css.js'  
//insertCSSStyleLink(CodeMirrorStyle)
document.adoptedStyleSheets.push(CodeMirrorStyle);
