...
import { diff_match_patch, DIFF_INSERT, DIFF_DELETE, DIFF_EQUAL } from './diff-match-patch.js'
import merge_css from './merge.css' with {type:'css'};

document.adoptedStyleSheets.push(merge_css);
