import tinycolor from '../../node_modules/TinyColor/mod.js';
import { getIdFromUrl } from '../dom-helpers.js';
import { convertToPixelUnit } from '../svg-units.js';
import { isIdentityTransform } from '../transformation.js';
import { gradientToColor } from './colors.js';
import { getEffectiveAttribute, getEffectiveElementOpacity } from './effective-attributes.js';
import { createPen } from './pens.js';
